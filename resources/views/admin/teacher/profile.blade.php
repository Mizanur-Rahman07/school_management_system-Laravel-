...
<div class="row">
    ...
    <div class="col-12 col-lg-8">
        <div class="card shadow-sm border-0 overflow-hidden">
            ...
            @if($teacher->id==Session::get('teacherId'))

            <div class="card-body">

                <div class="profile-avatar text-center mt-4">
                    <img src="{{ asset($teacher->image) }}" class="rounded-circle shadow" width="120" height="120"
                        alt="">
                </div>
                ...
                <div class="d-flex align-items-center justify-content-around mt-5 gap-3">
                    ...
                    <div class="text-center">
                        <a href=" {{route ('edit-tcr-profile',['id'=>$teacher->id])}}"
                            class=" btn btn-outline-secondary border p-2" style="color: black;"> <i
                ...
                <div class="text-center mt-4">
                    <h4 class="mb-1">{{ $teacher->teacher_name }}</h4>
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-top">
                    ...
                    <a href="#"> <span class="badge bg-dark rounded">{{ $teacher->teacher_phone }}</span></a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-top">
                    <strong>Email :</strong>
                    <a href="#"><span class="badge bg-dark rounded">{{ $teacher->teacher_email }}</span></a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-top">
                    <strong>Address :</strong>
                    <span class="">{{ $teacher->address }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-top">
                    Followers
