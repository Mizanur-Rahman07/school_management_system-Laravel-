...
@section('content')
<div class="row">
    <h5 class="">Teacher Registration Form</h5>
    <div class="col-xl-9 mx-auto">
        <h6 class="text-center text-uppercase">Add Teacher Form</h6>
        <hr />
                ...
                <div class="border p-4 rounded">
                    ...
                    <form action="{{ route ('new-teacher')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="teacher_name" class="form-control" id="inputEnterYourName"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="teacher_phone" class="form-control" id="inputPhoneNo2"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="email" name="teacher_email" class="form-control" id="inputEmailAddress2"
