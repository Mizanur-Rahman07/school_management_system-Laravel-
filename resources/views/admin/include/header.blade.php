                        ...
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('adminAsset')}}/assets/images/avatars/avatar-1.png" alt=""
                                        class="rounded-circle" width="60" height="60">
                                    @if(Session::get('teacherId'))
                                    <div class="ms-3">
                                        <h6 class="mb-0 dropdown-user-name">{{ Session::get('teacherName')}}</h6>
                                        <small class="mb-0 dropdown-user-designation text-secondary">Senior
                                            lecturer</small>
                                    </div>
                                    @else
                                    <div class="ms-3">
                                        <h6 class="mb-0 dropdown-user-name">Mizanur Rahman</h6>
                                        <small class="mb-0 dropdown-user-designation text-secondary">Software
                                            Engineer</small>
                                    </div>
                                    @endif
                                </div>
                            ...
                            <div class="col">
                                <a href="{{route('/')}}">
                                    <div class="apps p-2 radius-10 text-center">
                                        ...
                                        <p class="mb-0 apps-name">FrontEnd</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                ...
                <li class="nav-item dropdown dropdown-large">
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-0">
                        ...
                        <div class="header-message-list p-2">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('adminAsset')}}/assets/images/avatars/avatar-2.png" alt=""
                                        class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('adminAsset')}}/assets/images/avatars/avatar-3.png" alt=""
                                        class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('adminAsset')}}/assets/images/avatars/avatar-4.png" alt=""
                                        class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('adminAsset')}}/assets/images/avatars/avatar-5.png" alt=""
                                        class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('adminAsset')}}/assets/images/avatars/avatar-6.png" alt=""
                                        class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
