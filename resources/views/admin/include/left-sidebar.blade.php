        ...
        <div class="tab-content">
            <div class="tab-pane fade" id="dashboard">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{route('add-teacher')}}" class="list-group-item"><i class="bi bi-cart-plus"></i>Add
                        Teacher</a>
                    <a href="{{route('manage-teacher')}}" class="list-group-item"><i class="bi bi-cart-plus"></i>Manage
                        Teacher</a>
            ...
            <div class="tab-pane fade" id="course">
                <div class="list-group list-group-flush">
                    <div class="list-group-item">
                        ...
                        <small class="mb-0">Some courses content</small>
                    </div>
                    <a href="{{ route('add-course')}}" class="list-group-item"><i class="bi bi-envelope"></i>Add
                        Course</a>
                    <a href="{{('manage-course')}}" class="list-group-item"><i class="bi bi-envelope"></i>Manage
                        Course</a>
                    <a href="{{('manage-applicant')}}" class="list-group-item"><i class="bi bi-envelope"></i>Manage
                        Applicant</a>
            ...
            <div class="tab-pane fade" id="pills-widgets">
                <div class="list-group list-group-flush">
                    ...
                    <a href="widgets-static-widgets.html" class="list-group-item"><i class="bi bi-box"></i>Static
                        Widgets</a>
                    <a href="widgets-data-widgets.html" class="list-group-item"><i class="bi bi-bar-chart"></i>Data
                        Widgets</a>
                </div>
            </div>
